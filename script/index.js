const messages = [
    ...
    "풍성한 추석 보내시고, 가족들과 함께하는 시간 행복으로 가득하세요 💖🎉",
    "한가위 명절, 가족들과 함께 따뜻하고 즐거운 시간 보내세요 🥮🌟",
    "추석 명절 동안 마음 편히 쉬시고, 행복한 연휴 보내시길 바랍니다 😌🍁",
    "추석 연휴 동안 재충전하시고, 건강한 모습으로 다시 뵙길 바랍니다 🔋🌟",
    ...
    "한가위 보름달처럼 마음도 풍성해지는 따뜻한 명절 보내세요 🌕💞",
    "추석 명절 잘 보내시고, 가족들과 함께 행복한 시간 만드세요 👨‍👩‍👧‍👦🎊",
    "풍성한 한가위 되시고, 모든 일들이 잘 풀리시길 기원합니다 🍀🌟",
    "따뜻하고 행복한 추석 보내시고, 가족들과 소중한 시간 보내세요 💖🎈",
    "즐거운 추석 명절 되시길 바라며, 건강과 행복이 가득하시길 바랍니다 🙏🌼",
    "추석 연휴 동안 충분히 쉬시고, 행복한 시간 보내시길 바랍니다 😴🌟",
    "풍요롭고 따뜻한 한가위 되시길 바라며, 가족들과 행복한 시간 되세요 🌕🎉",
    "보름달처럼 밝고 풍요로운 추석 연휴 되시길 진심으로 기원합니다 🌝🌟",
    "가족과 함께하는 따뜻한 한가위, 행복과 건강 가득하시길 바랍니다 👨‍👩‍👧‍👦💖",
    "즐거운 추석 명절 보내시고, 모든 소망이 이루어지시길 바랍니다 🌠💫",
